Name "commerciumx ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/anthony19114/commerciumx/issues"
!define UPDATEURL "https://github.com/anthony19114/commerciumx/releases"
!define ABOUTURL "https://github.com/anthony19114/commerciumx#ethereum-go"
...
# Install commerciumx binary
Section "CommerciumX" GETH_IDX
  SetOutPath $INSTDIR
  file {{.CommerciumX}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\commerciumx.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\commerciumx.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "commerciumx incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "commerciumx outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "commerciumx UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "commerciumx incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\commerciumx.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "commerciumx outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\commerciumx.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "commerciumx UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\commerciumx.exe" "" "" "Ethereum" "" 30303 "" ""
